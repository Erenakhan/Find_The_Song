...
export default function Type() {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:5000/server/songTr')
          .then(response => {
        ...
        axios.get('http://127.0.0.1:5000/server/songGlobal')
          .then(response => {
        ...
        axios.get('http://127.0.0.1:5000/server/songTr90')
          .then(response => {
        ...
        axios.get('http://127.0.0.1:5000/server/songGlobal20')
          .then(response => {
